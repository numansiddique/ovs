...
class SSLStream(Stream):
    ...
    @staticmethod
    def _open(suffix, dscp):
        print("NUMS : SSLStream._open called : suffix = " + str(suffix))
    ...
    def connect(self):
        print("NUMS : SSLStream._connect called")
        ...
        try:
            print("NUMS : SSLStream._connect : calling do_handshake")
            self.socket.do_handshake()
        except SSL.WantReadError:
            return errno.EAGAIN

        print("NUMS : SSLStream._connect returning 0")
        return 0
